...
class MedicamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicamento" do
    assert_difference('Medicamento.count') do
      post medicamentos_url, params: { medicamento: { data_validade: @medicamento.data_validade, estoque: @medicamento.estoque, fornecedor_id: @medicamento.fornecedor_id, nome: @medicamento.nome, preco: @medicamento.preco, quantidade: @medicamento.quantidade, tipo: @medicamento.tipo } }
    end
  ...
  test "should update medicamento" do
    patch medicamento_url(@medicamento), params: { medicamento: { data_validade: @medicamento.data_validade, estoque: @medicamento.estoque, fornecedor_id: @medicamento.fornecedor_id, nome: @medicamento.nome, preco: @medicamento.preco, quantidade: @medicamento.quantidade, tipo: @medicamento.tipo } }
