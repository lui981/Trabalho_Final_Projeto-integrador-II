...
class ReceitaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receitum" do
    assert_difference('Receitum.count') do
      post receita_url, params: { receitum: { dosagem: @receitum.dosagem, medicamento_id: @receitum.medicamento_id, paciente: @receitum.paciente } }
    end
  ...
  test "should update receitum" do
    patch receitum_url(@receitum), params: { receitum: { dosagem: @receitum.dosagem, medicamento_id: @receitum.medicamento_id, paciente: @receitum.paciente } }
