...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post vendas_url, params: { venda: { cliente_id: @venda.cliente_id, data: @venda.data, medicamento_id: @venda.medicamento_id, valor: @venda.valor } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { cliente_id: @venda.cliente_id, data: @venda.data, medicamento_id: @venda.medicamento_id, valor: @venda.valor } }
